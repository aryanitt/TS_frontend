...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TS Publication — CRM" },
      { name: "description", content: "TS Publication admin and employee CRM — stories that inspire." },
      { name: "theme-color", content: "#be123c" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "default" },
      { name: "apple-mobile-web-app-title", content: "TS CRM" },
      { name: "application-name", content: "TS CRM" },
      { property: "og:title", content: "TS Publication — CRM" },
      { property: "og:description", content: "TS Publication admin and employee CRM — stories that inspire." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "TS Publication — CRM" },
      { name: "twitter:description", content: "TS Publication admin and employee CRM — stories that inspire." },
